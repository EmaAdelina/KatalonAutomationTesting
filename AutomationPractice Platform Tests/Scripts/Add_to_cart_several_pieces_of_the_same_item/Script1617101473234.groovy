...
WebUI.doubleClick(findTestObject("Object Repository/Item Page/Product quantity-plus button"));

WebUI.click(findTestObject("Object Repository/Item Page/Add to cart button"));

WebUI.delay(3);

WebUI.verifyElementText(findTestObject("Object Repository/Item Page/Confirmation message-Blouse"), item);

WebUI.verifyElementText(findTestObject("Object Repository/Item Page/Confirmation message-product quantity"), quantity);
